...
VALUES ('고양이 귀엽죠...ㅎ', 1, 14, NOW()),
       ...
       ('고양이 키우는 게1 어렵지 않나요?', 3, 14, NOW()),
       ('고양이 키우는 게 2어렵지 않나요?', 3, 14, NOW()),
       ('고양이 키우는 게 어3렵지 않나요?', 3, 14, NOW()),
       ('고양이 키우는 게 어렵4지 않나요?', 3, 14, NOW()),
       ('고양이 키우는 게 어렵지5 않나요?', 3, 14, NOW()),
       ('고양이 키우는 게 어렵지 6않나요?', 3, 14, NOW()),
       ('고양이 키우는 게 어렵지 않7나요?', 3, 14, NOW()),
       ('고양이 키우는 게 어렵지 않나8요?', 3, 14, NOW()),
       ('고양이 키우는 게 어렵지 않나요9?', 3, 14, NOW()),
       ('고양이 키우는 게 어렵지 않나요?10', 3, 14, NOW()),
       ('고양이 키우는 게 어렵지 않나요11?', 3, 14, NOW()),
