...
--     여기까지 1번 유저 ssar
       ...
       ('뉴질랜드 가보신분? (저요! 🙋‍♀️)', '뉴질랜드의 아름다운 바다 풍경을 담은 사진입니다 ^^', 2, 3, 'newZealand2.jpg', NOW()),

       ('홈트레이닝 다이어트 루틴', '집에서 운동하는 분들을 위한 효과적인 홈트레이닝 루틴을 소개합니다.', 3, 5, 'exercise.jpg', NOW());


INSERT INTO post_tb (title, content, user_id, category_id, thumbnail_file, created_at)
VALUES ('맛있는 초밥 만들기', '집에서 직접 만든 초밥 사진입니다ㅎㅎ 장인은 아니지만 장인 정신으로!! 신선한 재료와 정성으로 만들었어요~~!', 3, 4, 'sushi.jpg', NOW()),
       ('애니메이션 추천 - 이누야샤', '추억의 애니메이션 이누야샤! 인기 있는 애니메이션 중 하나였죠? 다양하고 매력 넘치는 주인공들의 활약이 인상 깊었어요.', 3, 7, 'anime.jpg', NOW()),
       ('코딩 공부 시작했어요!', '코딩 공부를 처음 시작했는데, 재미있네요. 앞으로 열심히 해서 프로그래밍 실력을 키워나가겠습니다. ^^ 파이팅!', 3, 6, 'coding.jpg', NOW()),
       ('요즘 인기 있는 드라마!! 우리, 사랑했을까', '최근 방영되고 있는 드라마 중 가장 재미있게 본 작품은 "우리, 사랑했을까"입니다. 주연 배우가 누구였죠???', 3, 8, 'drama.jpg', NOW()),
       ('제주도 여행 후기', '제주도에 다녀왔어요. 아름다운 자연 경관과 맛있는 음식들을 즐길 수 있었습니다. 다음에는 해외 여행을 한 번 가보고 싶네요. 어떤가요 ㅎ', 4, 1, 'jeju2.jpg', NOW()),
       ...
       ('일본 여행 갔다왔어요', '일본 도쿄와 교토를 다녀왔습니다. 전통문화와 현대문화가 공존하는 매력적인 여행지였어요. 무슨 인력거도 탔는데..... 재밌더라구요', 5, 1, 'japan3.jpg', NOW()),
       ('반려동물 돌봄 팁', '반려동물을 키우시는 분들을 위해 반려동물 돌봄 팁을 공유합니다. 1. 돈 없으면 키우지 말 것, 2. 시간 없으면 키우지 말 것', 5, 2, 'pet.jpg', NOW()),
       ('집에서 즐기는 홈파티', '친구들을 초대해서 집에서 간단한 홈파티를 열었어요. 맛있는 음식과 함께 즐거운 시간 보냈습니다.', 6, 4, 'party.jpg', NOW()),
       ('마루를 닮은 우리집 강아지 푸들! 강아!', '학교갔다 돌아오면 왈로아로와오왈!! 하고 짖는 우리집 강아를 소개합니다~~ 한강에 산책이라도 나가면 강아가 신나하며 뛰어다니는 모습이 정말 귀여웠어요.', 6, 2, 'dog6.jpg', NOW()),
       ('코로나19 극복 후기....', '코로나19 감염 후 완치되어 일상으로 돌아왔습니다. 건강의 소중함을 다시 한번 느꼈어요. 다시는 걸리고 싶지 않아요', 6, 6, 'covid.jpg', NOW()),
       ('애니메이션 리뷰 - 다이아몬드A!! (야구 애니)', '다이아몬드 에이스는 야구 선수들의 열정적인 경기 장면이 인상 깊었던 애니메이션입니다.', 7, 7, 'anime2.jpg', NOW()),
       ('최근 인기 있는 드라마', '최근 방영된 드라마 중 "스위트 홈"이 가장 재미있게 봤습니다. 긴장감 넘치는 스토리라인이 인상 깊었어요.', 6, 8, 'drama2.jpg', NOW()),
       ('여행 준비 팁 (다 쓸 수 있음 - 해외 여행 전용)', '여행을 준비하시는 분들을 위해 유용한 여행 준비 팁을 공유합니다.... 1. 돈!! 환전!!', 7, 1, 'travel.jpg', NOW()),
       ('IT 기술 동향 - 5G 네트워크 발전', '최근 5G 네트워크 기술의 발전 동향과 향후 전망에 대해 정리해보았습니다.', 3, 6, '5g_network.jpg', NOW());


INSERT INTO reply_tb (comment, user_id, post_id, created_at)
VALUES ('고양이 귀엽네요...', 1, 14, NOW()),
